# -- all bank services difined here--
...
class Bank():
    ...
    def deposit(self, amount):
        ...
        db_query(f"INSERT INTO {self.__username}_transaction VALUES ("
            ...
            f" '{amount}'"
            f")")
        print(f"{self.__username} Amount is Succesfully Deposited into Your {self.__account_number}")
...
def fundtransfer(self, receive, amount):
        ...
        if amount > temp[0][0]:
            ...
            if temp2 == []:
                print('account num doesnt match')
            else:
                test1 = temp[0][0] - amount
                test2= amount + temp2[0][0]
                ...
                receiver_username = db_query(f"SELECT balance FROM customers WHERE account_number = '{receive}';")
                self.balance_enquiry()
                if receiver_username:
                    try:
                        ...
                        db_query(f"INSERT INTO {self.__username}_transaction VALUES ("
                            ...
                            f"'{amount}'"
                            f")")
                        print(f"{self.__username} Amount is Succesfully Trascation From your '{self.__account_number}';")
        
                    except Exception as e:
                        print(f"error insering transaction: {e}")
